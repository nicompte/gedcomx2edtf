...
mod test {
    ...
    #[test]
    fn simple_date() {
        assert_eq!(conv("+2003"), "2003");
        assert_eq!(conv("+2003-03"), "2003-03");
        assert_eq!(conv("+2003-03-29"), "2003-03-29");
        assert_eq!(conv("+2003-03-29T11"), "2003-03-29T11");
        assert_eq!(conv("+2003-03-29T11:32"), "2003-03-29T11:32");
        // TODO: check - 00
        assert_eq!(conv("+2003-03-29T11:32Z"), "2003-03-29T11:32-00:00");
        // TODO: check + 00
        assert_eq!(conv("+2003-03-29T11:32+01"), "2003-03-29T11:32+01:00");
        assert_eq!(conv("+2003-03-29T11:32+01:30"), "2003-03-29T11:32+01:30");
        assert_eq!(conv("A+2003"), "2003~");
    }

    #[test]
    fn range() {
        assert_eq!(conv("+2003/+2004"), "2003/2004");
        assert_eq!(conv("+2003-10/+2004-12"), "2003-10/2004-12");
        assert_eq!(conv("+2003/"), "[2003,..]");
        assert_eq!(conv("/+2003"), "[..,2003]");
        assert_eq!(conv("A+2003/+2004"), "2003~/2004~");
        assert_eq!(conv("A+2003-10/+2004-12"), "2003-10~/2004-12~");
        assert_eq!(conv("A+2003/"), "[2003~,..]");
        assert_eq!(conv("A/+2003"), "[..,2003~]");
    }
}
